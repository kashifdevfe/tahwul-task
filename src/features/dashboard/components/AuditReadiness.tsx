...
export const AuditReadiness = ({ score }: AuditReadinessProps) => {
    ...
    return (
        <div className="bg-white rounded-[20px] p-4 sm:p-6 shadow-sm flex flex-col w-full min-h-[258px] h-full border border-slate-50 min-w-0">
            <h2 className="heading-bold text-slate-800 mb-4">{CHART_LABELS.AUDIT_READINESS}</h2>
            <div className="relative h-[170px] sm:h-[190px] w-full">
                ...
                <div className="absolute bottom-0 left-1/2 -translate-x-1/2 text-center pb-2">
                    ...
                    <p className="text-[10px] text-slate-400 font-normal uppercase tracking-wider mt-0.5">{CHART_LABELS.READINESS_LEVEL}</p>
                </div>
            </div>

            <div className="grid grid-cols-2 gap-2 mt-3 pt-4 border-t border-slate-100">
                <div className="text-center">
                    <p className="text-xl font-normal text-primary">12</p>
                    <p className="text-[10px] font-normal text-sidebar-muted uppercase leading-tight">{CHART_LABELS.OVERDUE_STANDARDS}</p>
                </div>
                <div className="text-center">
                    <p className="text-xl font-normal text-primary">5</p>
                    <p className="text-[10px] font-normal text-sidebar-muted uppercase leading-tight">{CHART_LABELS.MISSING_EVIDENCE}</p>
                </div>
            </div>
        </div>
    );
